...
fn aws_claude_models() -> Vec<ModelInfo> {
    vec![
        // === Claude 4.6 系列 ===
        ModelInfo {
            id: "anthropic.claude-sonnet-4-6-20250514-v1:0".to_string(),
            description: "Claude Sonnet 4.6 (Bedrock)，200K context，$3/$15".to_string(),
        },
        ModelInfo {
            id: "anthropic.claude-opus-4-6-20250514-v1:0".to_string(),
            description: "Claude Opus 4.6 (Bedrock)，200K context，$15/$75".to_string(),
        },
        // === Claude 4.5 系列 ===
        ModelInfo {
            id: "anthropic.claude-sonnet-4-5-20250929-v1:0".to_string(),
            description: "Claude Sonnet 4.5 (Bedrock)，200K context，$3/$15".to_string(),
        },
        ModelInfo {
            id: "anthropic.claude-opus-4-5-20250915-v1:0".to_string(),
            description: "Claude Opus 4.5 (Bedrock)，200K context，$15/$75".to_string(),
        },
        // === Claude 3.5 系列 ===
        ModelInfo {
            id: "anthropic.claude-3-5-sonnet-20241022-v2:0".to_string(),
            description: "Claude 3.5 Sonnet v2 (Bedrock)，200K context，$3/$15".to_string(),
        },
        ModelInfo {
            id: "anthropic.claude-3-5-haiku-20241022-v1:0".to_string(),
            description: "Claude 3.5 Haiku (Bedrock)，200K context，$0.8/$4".to_string(),
        },
        // === Claude 3 系列 ===
        ModelInfo {
            id: "anthropic.claude-3-haiku-20240307-v1:0".to_string(),
            description: "Claude 3 Haiku (Bedrock)，200K context，$0.25/$1.25".to_string(),
        },
    ]
}
