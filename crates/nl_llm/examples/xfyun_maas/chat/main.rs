use anyhow::Result; use nl_llm::{LlmClient, PrimitiveRequest};
#[tokio::main] async fn main() -> Result<()> {
    ...
    let client = LlmClient::from_preset("xfyun_maas").expect("preset").auth(nl_llm::auth::providers::xfyun_maas::XfyunMaasAuth::new(api_key)).build();
