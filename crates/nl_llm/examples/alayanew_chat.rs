...
async fn main() -> Result<()> {
    let api_key = std::env::var("ALAYANEW_API_KEYS").unwrap_or_else(|_| "dummy_credential".to_string());

    let client = LlmClient::from_preset("alayanew")
    ...
    println!("Sending request to AlayaNew...");
