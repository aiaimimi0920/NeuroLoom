...
use crate::provider::aiproxy::{AiProxyExtension, AiProxyModelResolver};
...
/// 完全兼容 OpenAI 的请求载荷，并提供模型列表的扩展功能（AiProxyExtension）。
pub fn builder() -> ClientBuilder {
    ...
    ClientBuilder::new()
        ...
        .with_extension(Arc::new(AiProxyExtension::new(base_url)))
}
