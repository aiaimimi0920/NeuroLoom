...
//!
//! 运行方式:
//!   方式1: cargo run -p nl_llm_v2 --example cloudflare_chat -- <api_token> [prompt]
...
async fn main() -> anyhow::Result<()> {
    let api_key = std::env::var("CLOUDFLARE_API_TOKEN")
        ...
        .unwrap_or_else(|_| {
            eprintln!("用法: cloudflare_chat <API_TOKEN> [prompt]");
    ...
    println!("========================================");
    println!("  Cloudflare Workers AI 基础对话");
    println!("========================================\n");
    println!("模型: @cf/meta/llama-3.3-70b (默认)");
