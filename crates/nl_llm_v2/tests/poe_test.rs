...
async fn test_poe_chat() {
    let api_key = env::var("POE_API_KEY")
        .unwrap_or_else(|_| "VEgG8gVETAQo_SA-A6jv_eZ7wHPnbRQvyMlVVa_asEo".to_string());

    let client = LlmClient::build_poe(None::<String>, api_key);
