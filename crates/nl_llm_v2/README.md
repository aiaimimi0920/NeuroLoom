...
To provide the cleanest "What You See Is What You Get" integration interface, `nl_llm_v2` inherently decouples service permutations. Instead of clunky runtime toggles, you explicitly initialize the EXACT business requirement via `LlmClient::from_preset("ID")`. 
